---
mode: 'agent'
tools: ['githubRepo', 'codebase', 'semantic_search', 'read_file', 'file_search']
description: 'AI-Volt onboarding - Multi-agent supervisor/worker system with specialized TypeScript agents'
context: 'voltagent-framework-typescript-multi-agent'
agentMode: 'supervisor-coordinator'
expertise: ['typescript', 'voltagent', 'vercel-ai-sdk', 'google-ai', 'multi-agent-systems']
---
